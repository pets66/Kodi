...
#define PVR_HAS_TIMESHIFT_BEFORE_EVENT    (PVR_CONDITIONS_START + 19)
#define PVR_HAS_TIMESHIFT_AFTER_EVENT     (PVR_CONDITIONS_START + 20)
#define PVR_CONDITIONS_END          PVR_HAS_TIMESHIFT_AFTER_EVENT
...
#define PVR_TIMESHIFT_START_PROGRESS      (PVR_STRINGS_START + 64)
#define PVR_TIMESHIFT_END_PROGRESS        (PVR_STRINGS_START + 65)
#define PVR_TIMESHIFT_BEFORE_EVENT_TIME   (PVR_STRINGS_START + 66)
#define PVR_TIMESHIFT_AFTER_EVENT_TIME    (PVR_STRINGS_START + 67)
#define PVR_STRINGS_END             PVR_TIMESHIFT_AFTER_EVENT_TIME
